...
class WebhookController(http.Controller):
    ...
    @http.route('/shopify_api/orders/paid', type='jsonrpc', auth='public', methods=['POST'], csrf=False)
    ...
    @http.route('/shopify_api/orders/updated', type='jsonrpc', auth='public', methods=['POST'], csrf=False)
    ...
    @http.route('/shopify_api/orders/fulfilled', type='jsonrpc', auth='public', methods=['POST'], csrf=False)
    ...
    @http.route('/shopify_api/draft_orders/update', type='jsonrpc', auth='public', methods=['POST'], csrf=False)
